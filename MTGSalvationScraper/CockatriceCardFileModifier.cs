...
{
    class CockatriceCardFileModifier : ICardFileModifier
    {
        ...
        private void AddCard(string setName, cockatrice_carddatabase cardDatabase, CardElement newCardElement)
        {
            ...
            var cardSetList = new List<cockatrice_carddatabaseCardSet>(new[] { new cockatrice_carddatabaseCardSet { Value = setName,picURL = newCardElement.ImageUrl} });
            foreach (
                var currentSets in cardList
